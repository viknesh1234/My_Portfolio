            ...
            <div className='bg-gray-100 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='mt-10'>
                        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                            <div>
                                ...
                                <p className='mt-4 text-lg text-gray-600'>
                                  With hands-on experience across both frontend and backend development, I create seamless, user-friendly systems backed by efficient and secure server-side logic. I enjoy working with modern tech stacks to build projects that are reliable, maintainable, and deliver great user experiences.
                                </p>
                                <p className='mt-4 text-lg text-gray-600'>
                                   I bring a strong problem-solving mindset and a continuous drive to learn and evolve with new technologies. I'm always excited to contribute to impactful projects and collaborate with other developers to create innovative, high-quality software solutions.
                                </p>
                            ...
                            <div className='border border-red-200 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-red-300'>
                                ...
                                <div className='flex items-center justify-center flex-wrap gap-3'>
                                    ...
                                    <div className='border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300'>
                                        <img src={ReduxLogo} alt="" className='w-8 rounded-full' />
                                    ...
                                    <div className='border border-red-300 flex items-center  w-max px-2 py-1 rounded-lg shadow-md shadow-red-300'>
                                        ...
                                        <span className='font-semibold'>My sql</span>
                                    </div>
                                    <div className='border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300'>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='mt-4 text-lg text-gray-600'>
                            I am a college student with a strong interest in full-stack web development and emerging technologies. Apart from coding, I am passionate about learning new programming tools and frameworks, and I consistently keep myself updated with the latest trends in modern web development. I enjoy working with technologies such as Java, Spring Boot, PostgreSQL, Git, GitHub, and Java Full Stack development. I am committed to building my skills through self-driven learning and practical projects, with a continuous focus on growth and innovation in the tech space.
                        </p>
                    </div>
                </div>
            </div>
